...
public extension NSMutableAttributedString{
    ...
    /// 设置不同的文本
    func getDiffirentText(needText:String,font:UIFont,fontColor:UIColor?=nil)->NSMutableAttributedString{
    ...
    convenience init(string:String?,lineSpacing:CGFloat=0,font:UIFont=UIFont.systemFont(ofSize: 15)){
